...
Module: TradovS01_DIXCalculator.py
...
class TradovDIXCalculator:
    ...
    Example:
        >>> calculator = TradovDIXCalculator()
    ...
    def __init__(self):
        ...
        self.logger = TradovLogger.get_logger(__name__) if hasattr(TradovLogger, 'get_logger') else logging.getLogger(__name__)  # noqa: E501
...
class DIXCalculator:
    ...
    def __init__(self):
        ...
        # Reuse one TradovDIXCalculator instance across calls so that cached
        # S&P 500 constituents and FINRA data are retained between updates.
        self._inner = TradovDIXCalculator()

    def calculate_dix_internal(self) -> DIXResult:
        """Internal DIX calculation — delegates to shared TradovDIXCalculator."""
    ...
    def calculate_dix_simulated(self) -> dict:
        ...
        raise DataUnavailableError(
            "DIX simulation is disabled. Tradov requires real FINRA short volume "
