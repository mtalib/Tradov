...
class PerformanceAnalyticsAgent:
    ...
    def __init__(
        ...
        if SpyderLogger is not None:
            self.logger = SpyderLogger.get_logger(__name__)
        else:
            self.logger = logging.getLogger(__name__)

        if SpyderErrorHandler is not None:
    ...
    def _build_analysis_prompt(
        ...
        return (
            "Analyse the following SPY options trading performance data "
...
SpyderX08_PerformanceAnalyticsAgent = PerformanceAnalyticsAgent
