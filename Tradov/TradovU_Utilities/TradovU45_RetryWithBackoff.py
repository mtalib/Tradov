...
Module Description:
    ...
    TradovU41_CircuitBreaker — use retry for transient network errors and circuit
    ...
    Usage:
        ...
        # Inline (async)
        result = await retry_call_async(fetch_quotes, "TRAD", max_attempts=3)

        # Inline (sync)
        result = retry_call_sync(fetch_historical, "TRAD", max_attempts=3)
"""
