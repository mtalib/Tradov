...
Spyder Version: 1.0
Module: SpyderT16_SystemHealthMonitor.py
Group: T (Testing)
...
class SystemHealthMonitor:
    ...
    def _display_status(self, health: SystemHealth):
        ...
        print(f"{Style.BRIGHT}{Fore.CYAN}║{' '*20}SPYDER SYSTEM HEALTH MONITOR{' '*30}║")
        print(f"{Style.BRIGHT}{Fore.CYAN}╚{'═'*78}╝")
        ...
        status_color = {
            ...
            'CRITICAL': Fore.RED
        }.get(health.overall_status, Fore.WHITE)
    ...
    def get_health_summary(self) -> Dict:
        ...
        return {
            ...
            'overall_status': self.current_health.overall_status if self.current_health else 'UNKNOWN',
...
def main():
    ...
    print(f"{Style.BRIGHT}{Fore.CYAN}Starting Spyder System Health Monitor...")
