...
Purpose: PyQt6 trading dashboard for monitoring and control

Description:
This module provides a comprehensive PyQt6-based trading dashboard for the Spyder
...
integrates seamlessly with the existing PyQt6 GUI framework.
