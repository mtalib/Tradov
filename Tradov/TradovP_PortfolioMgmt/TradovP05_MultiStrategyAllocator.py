...
Tradov Version: 1.0
Module: TradovP05_MultiStrategyAllocator.py
...
from Tradov.TradovI_Integration.TradovI06_AgentMessageBus import MessagePriority
...
STRATEGY_IDS = [
    'D01_BaseStrategy', 'D02_LongEquity', 'D03_DirectionalTrade', 'D04_DayTrade',
    'D05_SpreadPosition', 'D06_BullPutSpread', 'D07_BearCallSpread',
    'D08_OpeningRangeBreakout', 'D09_GreeksBased', 'D10_IronPositionGroup',
    'D11_SpecializedDayTrade', 'D12_RSIMeanReversion', 'D13_MACrossover',
    'D14_CalendarSpread', 'D15_SpreadPositionHedgePosition', 'D16_RatioSpreads',
    'D17_DiagonalSpread', 'D18_EvolvedDirectionalTrade', 'D19_JadeLizard',
...
class MultiStrategyAllocator:
    ...
    def _initialize_risk_limits(self):
        ...
        # Higher risk for Intraday strategies
        for strategy_id in ['D04_DayTrade', 'D11_SpecializedDayTrade']:
...
if __name__ == "__main__":
    ...
    test_strategies = ['D02_LongEquity', 'D03_DirectionalTrade', 'D04_DayTrade',
                      'D05_SpreadPosition', 'D06_BullPutSpread']
