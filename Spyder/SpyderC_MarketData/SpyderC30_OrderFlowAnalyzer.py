...
class OrderFlowAnalyzer:
    ...
    def get_gamma_exposure(
        ...
        if use_cache and symbol in self._gex_cache:
            ...
            if (datetime.now(UTC) - cache_time).seconds < cache_ttl:
        ...
        try:
            ...
            self._gex_cache_time[symbol] = datetime.now(UTC)
    ...
    def calculate_max_pain(
        ...
        try:
            ...
            if cache_key in self._max_pain_cache:
                ...
                if (datetime.now(UTC) - cached.timestamp).seconds < 300:  # 5 min cache
                    return cached
