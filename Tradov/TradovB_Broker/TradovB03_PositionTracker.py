...
Module: TradovB03_PositionTracker.py
...
def _default_state_path() -> Path:
    ...
    return Path.home() / ".tradov" / "position_tracker_state.json"
...
class PositionTracker:
    ...
    def __init__(
        ...
        # market close order via self.tradov_client.
    ...
    def reconcile_with_broker(self, tolerance: float = 0.01) -> bool:
        ...
        client = getattr(self, "tradov_client", None)
    ...
    def _handle_orphaned_position(self, symbol: str) -> None:
        ...
        direct market-sell/buy-to-close via self.tradov_client.
        """
        ...
        if client is None:
            ...
            return
        try:
            from Tradov.TradovB_Broker.TradovB00_OrderTypes import OrderSide, OrderType
...
def create_position_tracker(
    ...
    Args:
        tradov_client: TradovClient instance
