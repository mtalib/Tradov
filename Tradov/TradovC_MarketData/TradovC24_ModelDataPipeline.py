...
Module: TradovC24_ModelDataPipeline.py
...
try:
    ...
    from evidently.metric_preset import DataDriftPreset, DataQualityPreset  # noqa: F401
...
try:
    ...
    from TradovU13_TechnicalIndicators import calculate_technical_indicators
    TRADOV_INDICATORS_AVAILABLE = True
except ImportError:
    ...
    TRADOV_INDICATORS_AVAILABLE = False
...
try:
    from TradovC22_FactorDataProvider import get_factor_data_provider
    C22_AVAILABLE = True
except ImportError:
    C22_AVAILABLE = False

try:
    from TradovF13_ModelValidation import get_model_validation_engine
    F13_AVAILABLE = True
except ImportError:
    F13_AVAILABLE = False
    ...
    def _initialize_integrations(self) -> None:
        ...
        try:
            ...
            if C22_AVAILABLE:
                ...
                self.logger.info("Connected to TradovC22_FactorDataProvider")

            # Connect to F13 Model Validation
            if F13_AVAILABLE:
                self.model_validator = get_model_validation_engine()
                self.logger.info("Connected to TradovF13_ModelValidation")
    ...
    def _create_technical_feature_engineer(self) -> Callable:
        ...
        def engineer_technical_features(data: pd.DataFrame) -> pd.DataFrame:
            try:
                ...
                # Use Tradov technical indicators if available
                if TRADOV_INDICATORS_AVAILABLE:
...
async def main():
    ...
    logging.info("🎯 TRADOV C24 - Model Data Pipeline")
    logging.info("=" * 80)
    ...
    try:
        ...
        logging.info("   Data Quality Scores:")
