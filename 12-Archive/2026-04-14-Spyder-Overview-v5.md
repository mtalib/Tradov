# Spyder Trading System — Codebase Review v17 (v5)
**Date:** April 17, 2026
**Scope:** Current-state inventory of the Spyder codebase
**Prepared by:** Claude Sonnet 4.6
**Supersedes:** 2026-04-14-Spyder-Overview-v4.md

---

## Change Summary (v4 → v5)

This revision incorporates all changes from the **Audit v18 remediation lifecycle** (Phases 1–5, branches merged to `master` by April 17, 2026) and the active **G05 decomposition workstream** (`refactor/g05-widget-extraction`):

- **G-Series expanded**: G17, G18, G19, G20, G21 added to the catalogue (5 new production modules); G05 reduced from 6,595 → 3,535 LOC; G13 expanded from 749 → 1,676 LOC.
- **Architectural notes updated**: A02 now uses typed `validate_signal(RiskValidationRequest)` at the risk gate; Q10 CI gate has four active gates; Y01 MarketSenseAgent routes regime through L09 (canonical) with E21 HMM fallback.
- **Module descriptions updated**: A02, E13, J02, Q10, R04, T117, T129, Y01.
- **Codebase metrics updated**: +5 production files, +1 test file, ~+1,100 net LOC.
...
| Total lines of code | **425,300** |
| Production LOC | **331,160** |
| Test LOC | **94,140** |
| Series (packages) | **25** |
...
| G | `SpyderG_GUI` | 25 | 18,613 | PySide6 interface, dashboards, charts, widgets |
...
**Package:** `SpyderG_GUI` | **25 files** | **18,613 LOC**
...
*End of Spyder Codebase Review v17 (v5) — April 17, 2026*
