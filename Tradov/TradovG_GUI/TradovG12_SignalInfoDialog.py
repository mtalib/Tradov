...
Tradov Version: 1.0
Module: TradovG12_SignalInfoDialog.py
...
from Tradov.TradovG_GUI.TradovG06_DashboardData import get_market_signal_dialog_metadata  # noqa: E402
    ...
    def get_signal_content(self) -> dict:
        ...
        signal_contents = {
            ...
            "AI DECISION": {
                ...
                "concept": "Analyzes multiple indicators using ML models to generate buy/sell signals for TRAD options",  # noqa: E501
                "signal_colors": [
                    {
                        "color": "positive",
