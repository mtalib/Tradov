...
from SpyderU_Utilities.SpyderU08_Validators import Validators
...
class IndicatorResult:
    ...
    def __init__(self, name: str, value: Union[float, pd.Series], 
...
class TechnicalIndicators:
    ...
    def _load_config(self):
        ...
        try:
            ...
            self.use_ml_signals = self.config_manager.is_feature_enabled('ml_indicator_signals')
    ...
    def macd(self, data: pd.Series, 
             fast: Optional[int] = None,
             slow: Optional[int] = None, 
             signal: Optional[int] = None) -> Dict[str, pd.Series]:
        """
    ...
    def bollinger_bands(self, data: pd.Series,
    ...
    def _validate_period(self, period: int):
        ...
        if period < self.min_data_points:
            raise ValueError(f"Period {period} is less than minimum {self.min_data_points}")
    ...
    def _record_performance(self, indicator_name: str, start_time: pd.Timestamp):
        ...
        # Record metric
        self.monitor.record_metric(f'indicators.{indicator_name}.execution_ms', elapsed_ms)
    ...
    def _cache_result(self, key: str, result: Any):
        ...
        self._cache_expiry[key] = datetime.now() + timedelta(seconds=self.cache_ttl_seconds)
