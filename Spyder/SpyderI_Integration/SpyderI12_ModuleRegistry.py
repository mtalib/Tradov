...
REGISTERED_MODULES: dict[str, ModuleRecord] = {
    ...
    "R09": ModuleRecord("R09", "SpyderR_Runtime", "SpyderR09_ProductionDeploymentManager",
                        ...
                        tags=["deployment"]),
    # ── U-Series: Utilities ───────────────────────────────────────────
    "U01": ModuleRecord("U01", "SpyderU_Utilities", "SpyderU01_Logger", "SpyderLogger",
                        "Thread-safe structured logging singleton", "U",
                        tags=["logging", "singleton"]),
    "U02": ModuleRecord("U02", "SpyderU_Utilities", "SpyderU02_ErrorHandler",
                        "SpyderErrorHandler",
                        "Centralised exception handling with retry logic", "U",
                        tags=["error_handling"]),
    "U07": ModuleRecord("U07", "SpyderU_Utilities", "SpyderU07_Constants", "CONSTANTS",
                        "System-wide constants — tick sizes, API endpoints, etc.", "U",
                        tags=["constants"]),
    "U10": ModuleRecord("U10", "SpyderU_Utilities", "SpyderU10_TradingCalendar",
                        "TradingCalendar",
