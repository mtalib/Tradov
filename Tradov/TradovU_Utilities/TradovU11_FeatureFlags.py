...
Module: TradovU11_FeatureFlags.py
...
def _matching_now(reference: datetime | None = None) -> datetime:
    ...
    if reference is not None and reference.tzinfo is None:
        return datetime.now()  # tradov: naive-ok
...
class FeatureFlags:
    ...
    def __init__(self, config_file: str = DEFAULT_CONFIG_FILE):
        ...
        self.environment = os.getenv("TRADOV_ENV", "development")
        self.user_id = os.getenv("TRADOV_USER_ID", "default")
...
def is_tradovx_enabled(feature_name: str, user_id: str | None = None) -> bool:
    """Check if a TradovX feature is enabled (alias for is_feature_enabled)."""
    return is_feature_enabled(feature_name, user_id)


# Default TradovX feature flags dictionary
TRADOVX_FEATURE_FLAGS: dict[str, bool] = {
    "USE_AI_RISK": False,
    "USE_AI_FLOW": False,
    "ENABLE_TRADOVX_SHADOW": False,
    "USE_AI_GREEKS": False,
