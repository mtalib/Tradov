...
Module: TradovX07_ExecutionStrategyAgent.py
...
def create_execution_strategy_agent(model_name: str = DEFAULT_MODEL,
                                  temperature: float = DEFAULT_TEMPERATURE) -> TradovX07_ExecutionStrategyAgent:  # noqa: E501
    """
    ...
    Returns:
        TradovX07_ExecutionStrategyAgent instance
    """
    return TradovX07_ExecutionStrategyAgent(model_name, temperature)
...
def get_module_instance() -> TradovX07_ExecutionStrategyAgent:
...
async def test_execution_agent():
    ...
    logging.info("="*80)
    logging.info("Testing TradovX07_ExecutionStrategyAgent")
    logging.info("="*80)
