...
try:
    ...
    try:
        ...
        warnings.warn("Using fallback OptionType - check SpyderU07_Constants.py", stacklevel=2)
...
try:
    ...
    warnings.warn("QuantLib not available. Install with: pip install quantlib-python", stacklevel=2)

# PyFolio for institutional performance analytics
try:
    import pyfolio as pf  # noqa: F401
    import empyrical as ep  # noqa: F401
...
try:
    from stable_baselines3 import PPO, SAC, A2C  # noqa: F401
...
try:
    ...
    from ray.rllib.algorithms import PPO as RayPPO  # noqa: F401
    RAY_AVAILABLE = True
    ...
    RAY_AVAILABLE = False
    warnings.warn("Ray not available. Install with: pip install ray[rllib]", stacklevel=2)
...
class InstitutionalLibraries:
    ...
    def price_option(self,
                    ...
                    dividend_yield: float = 0.0) -> OptionPricing | None:
        """
    ...
    def price_spread(self,
                    ...
                    volatility: float,
                    option_type: OptionType,
                    dividend_yield: float = 0.0) -> dict[str, Any] | None:
        """
    ...
    def optimize_portfolio(self,
                          ...
                          risk_free_rate: float | None = None) -> PortfolioOptimization | None:
        """
...
if __name__ == "__main__":
    ...
    for _lib, available in status.items():
