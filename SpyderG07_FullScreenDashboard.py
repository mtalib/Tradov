...
# Note: Using matplotlib instead of QtChart for better compatibility
import matplotlib
matplotlib.use('QtAgg')  # Updated for PyQt6
...
class SpyderFullScreenDashboard(QMainWindow):
    ...
    def __init__(self):
        ...
        super().__init__()
        self.logger = SpyderLogger()  # No arguments needed
        self.logger.setup("FullScreenDashboard")  # Set up logger
    ...
    def setup_chart(self):
        """Setup the SPY chart with test data."""
        # Create candlestick series
        series = QCandlestickSeries()
        series.setName("SPY")
        
        # Add test data (5-minute candles)
        base_price = 585.0
        current_time = datetime.now()
        
        for i in range(78):  # 78 5-minute candles = 6.5 hours
