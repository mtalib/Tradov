...
Series: TradovL_ML
Module: TradovL11_MLModelManager.py
...
MODEL_BASE_DIR = Path.home() / ".tradov" / "models"
...
from Tradov.TradovL_ML.TradovL01_MLPredictor import ModelConfig  # noqa: E402
from Tradov.TradovA_Core.TradovA05_EventManager import get_event_manager, EventType  # noqa: E402
try:
...
class MLModelManager:
    ...
    def register_model(
        ...
        try:
            ...
            if HAS_MLFLOW:
                try:
                    mlflow.set_experiment(f"tradov_{name}")
    ...
    def _update_model_status(self, model_id: str, status: ModelStatus) -> None:
        ...
        try:
            ...
            db.execute(query, (status.value, datetime.now(UTC), model_id))
...
# MODULE FUNCTIONS
# ==============================================================================
_model_manager_instance: MLModelManager | None = None
...
if __name__ == "__main__":
    ...
    # List models
    for _name, _model in manager.get_active_models().items():
        pass
