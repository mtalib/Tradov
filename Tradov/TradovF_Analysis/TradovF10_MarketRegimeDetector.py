...
Module: TradovF10_MarketRegimeDetector.py
...
DEPRECATED (2026-04-14): L09 UnifiedRegimeEngine is the canonical regime
    detector for Tradov. This module is retained for legacy F-series callers
...
class MarketRegimeDetector:
    ...
    def calculate_all_indicators(self, symbol: str, data: Any = None) -> Any:
        """Protocol stub — indicator calculation lives in TradovF01.
    ...
    def get_trading_signals(self, symbol: str = "") -> list:
        """Protocol stub — trading signal generation lives in TradovF01."""
        return []
        ...
        while self.monitoring_active:
            try:
                ...
                if hasattr(self, "_last_config_update"):
                    if (
                        datetime.now(UTC) - self._last_config_update
    ...
    def _update_regime_state(self) -> None:
        ...
        try:
            ...
            duration = 0
            if self.current_regime:
                duration = (datetime.now(UTC) - self.current_regime.timestamp).days
    ...
    def _load_configuration(self) -> None:
        ...
        try:
            ...
            self._last_config_update = datetime.now(UTC)
