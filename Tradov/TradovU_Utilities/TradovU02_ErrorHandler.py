...
Module: TradovU02_ErrorHandler.py
...
# EXCEPTIONS
# ==============================================================================
class TradovError(Exception):
    """Base exception for Tradov system"""
...
class ConnectionError(TradovError):
...
class ExecutionError(TradovError):
...
class TradingError(TradovError):
...
class TradovErrorHandler:
    """
    Centralized error handling system for Tradov.
    ...
    def __init__(self, event_manager=None):
        ...
        self.logger.debug("TradovErrorHandler initialized")
    ...
    def _create_error_context(
        ...
        if isinstance(error, str):
            ...
            if isinstance(error, TradovError):
    ...
    def _emit_error_event(self, error_context: ErrorContext):
        ...
        try:
            from TradovA_Core.TradovA05_EventManager import EventType
    ...
    def error_handler(component_name: str, strategy_name: str | None = None):
        ...
        Usage:
            @TradovErrorHandler.error_handler("OrderManager", "IronCondor")
...
# MODULE FUNCTIONS
# ==============================================================================
_error_handler_instance: TradovErrorHandler | None = None
_error_handler_lock = threading.Lock()


def get_error_handler() -> TradovErrorHandler:
    """Get singleton error handler instance"""
    global _error_handler_instance

    with _error_handler_lock:
        if _error_handler_instance is None:
            _error_handler_instance = TradovErrorHandler()
...
if __name__ == "__main__":
    ...
    try:
        raise RiskError("Position limit exceeded", symbol="TRAD")
    except Exception as e:
        context = handler.handle_error(
            e, "RiskManager", strategy_name="IronCondor", symbol="TRAD"
        )
