...
Legacy options strategy modules remain in the repository for historical reference, but the active deployment is stock/ETF-only and the D31 strategy registry is retired from the live execution path.
