...
def main():
            ...
            try:
                with open(desktop_file) as f:
                    ...
                    if "SpyderG14_Dashboard.py" in content:
                        print_error("  ⚠️  Contains incorrect reference to SpyderG14_Dashboard.py")
                        print_info("  📝 This file needs to be fixed!")
                    else:
                        print_success("  ✅ No incorrect references found")
    ...
    print()
    print("2. OR update your launcher to use the correct file:")
