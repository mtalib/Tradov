...
class GreeksCalculator:
    ...
    def calculate_implied_volatility(
        ...
        try:
            ...
            math.sqrt(2 * math.pi / T) * (option_price / S)
    ...
    def _validate_inputs(
        ...
        if T == 0:
            warnings.warn("Time to expiration is zero", stacklevel=2)
...
if __name__ == "__main__":
    ...
    for _greek, _value in euro_greeks.items():
        pass
    ...
    for _greek, _value in amer_greeks.items():
        pass
    ...
    for _greek, _value in div_greeks.items():
        pass
    ...
    for _greek, _value in port_greeks.items():
        pass
