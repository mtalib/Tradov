...
# Security settings
ENCRYPTION_KEY_FILE = '.tradov_encryption_key'
SENSITIVE_KEYS = {
...
class ConfigManager:
    """
    Centralized configuration management system for TRADOV modules.
    ...
    hot reloading capabilities across all TRADOV modules.
    ...
    def __init__(self, config_dir: Path | None = None, environment: str = 'development'):
        ...
        if HUB_AVAILABLE:
            ...
            if hub:
                hub.register_module(self, dependencies=['TradovU04_Encryption'])
