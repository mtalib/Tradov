...
Module: TradovF07_GapAnalyzer.py
...
class GapAnalysis:
    ...
    def is_acceptable_for_entry(self) -> bool:
        ...
        return self.current_gap.gap_type != GapType.EXHAUSTION
...
class GapAnalyzer:
    ...
    def analyze(self, data: pd.DataFrame,
               current_price: float | None = None) -> GapAnalysis:
        """
    ...
    def calculate_overnight_gap(self,
        ...
        return Gap(
            gap_time=datetime.now(UTC).replace(hour=9, minute=30),
...
if __name__ == "__main__":
    ...
    # Unfilled zones
    for _i, (_low, _high) in enumerate(analysis.gap_zones[:3]):
        pass
