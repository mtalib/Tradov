...
Module: TradovX04_RiskGuardianAgent.py
...
# MAIN CLASS
# ==============================================================================
class TradovX04_RiskGuardianAgent:
    """
    ...
    async def assess_portfolio_risk(
        ...
        try:
            ...
            if is_tradovx_enabled("USE_AI_RISK") and OLLAMA_AVAILABLE:
...
Format as JSON with keys: risk_level, summary, key_risks, recommendations, hedges, confidence"""
    ...
    async def _activate_circuit_breaker(self, level: str, triggers: list[str]) -> None:
        ...
        self.circuit_breaker = CircuitBreakerStatus(
            ...
            estimated_reset_time=datetime.now(UTC) + timedelta(minutes=30),
...
def get_module_instance() -> TradovX04_RiskGuardianAgent:
