...
Module Description:
    ...
    for the Tradov trading system. It tracks memory usage patterns, detects leaks,
...
def get_memory_monitor() -> TradovMemoryMonitor:
    """Get the global memory monitor instance."""
    global _global_memory_monitor
    if _global_memory_monitor is None:
        _global_memory_monitor = TradovMemoryMonitor()
...
def main():
    ...
    logging.info("Tradov Memory Monitor Demo")
    logging.info("=" * 50)

    # Create monitor
    monitor = TradovMemoryMonitor()
