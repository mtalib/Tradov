# Trading Decision Workflow (Full) — v2
...
6. Enforce hard halt rules for EVENT/CRISIS.
7. Enforce max two concurrent strategies.
8. Pass only allowed strategy signals downstream to risk and execution.
