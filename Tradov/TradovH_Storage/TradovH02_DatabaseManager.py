...
Tradov Version: 1.0
Module: TradovH02_DatabaseManager.py
Group: H (Storage)
...
# CONSTANTS
# ==============================================================================
DATABASE_PATH = Path("data/tradov_trading.db")
...
class DatabaseManager:
    """
    Comprehensive database manager for Tradov trading system
    ...
    def backup_database(self) -> Path:
        ...
        backup_file = self.backup_path / f"tradov_backup_{timestamp}.db"
    ...
    def _cleanup_old_backups(self):
        ...
        backups = sorted(self.backup_path.glob("tradov_backup_*.gz"))
...
if __name__ == "__main__":
    ...
    latest = db_manager.get_latest_market_data("TRAD")
