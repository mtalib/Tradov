...
Module: TradovC10_VIXAnalyzer.py
...
try:
    from Tradov.TradovC_MarketData.TradovC29_DataProviderRouter import get_data_provider as _get_c29_provider  # noqa: E501, F401
    _C29_AVAILABLE = True
except ImportError:
...
try:
    from Tradov.TradovU_Utilities.TradovU13_TechnicalIndicators import MAType as MovingAverageType
except ImportError:
    from enum import Enum
...
try:
    from Tradov.TradovU_Utilities.TradovU13_TechnicalIndicators import TechnicalIndicators
...
from Tradov.TradovC_MarketData.TradovC06_DataValidator import DataValidator
from Tradov.TradovA_Core.TradovA05_EventManager import get_event_manager, EventType, Event
...
class VIXAnalyzer:
    ...
    def __init__(self, config: dict | None = None, tradier_client: Any = None):
        ...
        Args:
            ...
            tradier_client: Optional TradovB40_TradierClient instance. When
        ...
        """
        self.logger = TradovLogger.get_logger("VIXAnalyzer")
        ...
        self.volatility_metrics: VolatilityMetrics | None = None
        self.term_structure: TermStructure | None = None
    ...
    def _on_vix_update(self, event: Event) -> None:
        ...
        try:
            ...
            if symbol in VIX_SYMBOLS and price > 0:
                vix_data = VIXData(
                    symbol=symbol,
                    value=price,
                    timestamp=event.timestamp or datetime.now(UTC)
    ...
    def _update_risk_premium(self) -> None:
        ...
        try:
            ...
            # Get TRAD data for realized volatility calculation
    ...
    def _detect_regime_shift(self) -> bool:
        ...
        return bool(all(regime != current_regime for regime in recent_regimes))
    ...
    def _get_spy_realized_volatility(self) -> dict[str, float] | None:
        """Get TRAD realized volatility for different periods."""
        try:
            # This would typically get TRAD price data and calculate realized vol
    ...
    # PUBLIC API METHODS
    # ==========================================================================
    def get_current_metrics(self) -> VolatilityMetrics | None:
        """
    ...
    def get_term_structure(self) -> TermStructure | None:
        """
    ...
    def get_risk_premium(self) -> VolatilityRiskPremium | None:
        """
    ...
    def get_latest_signal(self) -> VIXSignalData | None:
        """
    ...
    def get_vix_percentile(self, period: int = 252) -> float | None:
        """
...
# MODULE FUNCTIONS
# ==============================================================================
def get_vix_analyzer(config: dict | None = None) -> VIXAnalyzer:
    """
...
# ==============================================================================
# Global instance
_vix_analyzer_instance: VIXAnalyzer | None = None
...
if __name__ == "__main__":
    ...
    if analyzer.initialize():
        ...
        if signals:
            for _signal in signals[-3:]:  # Show last 3
                pass

        strategies = analyzer.get_recommended_strategies()
        for _strategy in strategies[:5]:  # Show first 5
            pass
