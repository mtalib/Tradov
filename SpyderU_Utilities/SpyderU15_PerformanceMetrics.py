...
class PerformanceCalculator:
    ...
    def calculate_annualized_return(self, returns: pd.Series, periods_per_year: int = TRADING_DAYS_PER_YEAR) -> float:
        """
    ...
    def calculate_volatility(self, returns: pd.Series, periods_per_year: int = TRADING_DAYS_PER_YEAR) -> float:
        """
    ...
    # ==========================================================================
    def calculate_sharpe_ratio(self, returns: pd.Series, periods_per_year: int = TRADING_DAYS_PER_YEAR) -> float:
        """
    ...
    def calculate_sortino_ratio(self, returns: pd.Series, periods_per_year: int = TRADING_DAYS_PER_YEAR) -> float:
        """
    ...
    # PERFORMANCE RATING
    # ==========================================================================
    def rate_performance(self, sharpe_ratio: float, calmar_ratio: float, win_rate: float) -> PerformanceRating:
        """
    ...
    def generate_performance_report(self, returns: pd.Series) -> PerformanceReport:
        ...
        try:
            ...
            return PerformanceReport(
                ...
                winning_trades=0, losing_trades=0, rating=PerformanceRating.VERY_POOR
            )
