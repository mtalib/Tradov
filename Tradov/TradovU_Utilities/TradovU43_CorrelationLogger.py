...
class StructuredFormatter(logging.Formatter):
    ...
    ``module``
        Source module filename (e.g. ``"TradovB40_TradierClient"``)
    ``line``
...
def setup_correlation_logging(
    ...
    Example
    -------
    >>> setup_correlation_logging(log_file="logs/tradov_trades.log")
    """
...
if __name__ == "__main__":
    ...
    demo_logger = logging.getLogger("TradovU43.Demo")
    ...
    # -----------------------------------------------------------------------
    with correlation_context(trade_id="TRD-001", strategy_id="IronCondor") as cid:
        demo_logger.info("Order submitted | symbol=TRAD expiry=2026-04-17 strike=500/505")
