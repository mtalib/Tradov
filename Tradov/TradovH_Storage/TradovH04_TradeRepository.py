...
Module: TradovH04_TradeRepository.py
...
try:
    from Tradov.TradovH_Storage.TradovH01_DataAccessLayer import DataAccessLayer
except ImportError:
...
class TradeRepository:
    ...
    def _row_to_trade(self, row: dict[str, Any]) -> Trade:
        ...
        return Trade(
            ...
            created_at=datetime.fromisoformat(row['created_at']) if row.get('created_at') else datetime.now(UTC),  # noqa: E501
