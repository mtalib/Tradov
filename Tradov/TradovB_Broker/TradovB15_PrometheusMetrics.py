...
Module: TradovB15_PrometheusMetrics.py
...
Module Description:
    Centralized Prometheus metrics collection and HTTP endpoint for the Tradov
...
try:
    ...
    logging.info("WARNING: TradovLogger not available - using basic logging")
    import logging
    class TradovLogger:
        @staticmethod
        def get_logger(name):
...
try:
    ...
    logging.info("WARNING: TradovErrorHandler not available - using basic error handling")
...
class TradingMetrics:
    ...
    def update_portfolio_value(self, total_value: float, cash_balance: float):
        ...
        self.current_snapshot.portfolio.last_updated = datetime.now(UTC)
...
class PrometheusMetricsCollector:
    """
    Centralized Prometheus metrics collector for the Tradov system.
    ...
    def __init__(self, config: MetricsConfig | None = None):
        ...
        self.metrics = TradovMetrics(self.registry) if HAS_PROMETHEUS else None
        ...
        self._last_system_update = datetime.now(UTC)
    ...
    def _should_update_system_metrics(self) -> bool:
        ...
        return (datetime.now(UTC) - self._last_system_update).total_seconds() >= self._system_metrics_interval  # noqa: E501
    ...
    def _update_trading_metrics(self):
        ...
        try:
            ...
            # Position count
            self.metrics.position_count.labels(symbol="TRAD", strategy="ALL").set(portfolio.total_positions)  # noqa: E501
    ...
    def _check_client_connection(self, client_id: int) -> bool:
        ...
        # This would integrate with TradovB14_MultiClientWatchdog
    ...
    def record_fill_latency(self, order_type: str, symbol: str, latency_ms: float):
        ...
        Args:
            ...
            symbol: Instrument symbol (e.g. 'TRAD').
...
try:
    if "TradovLogger" in globals():
        PrometheusMetrics = TradovLogger
    else:
