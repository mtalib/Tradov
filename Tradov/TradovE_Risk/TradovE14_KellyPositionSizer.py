...
Series: TradovE_Risk
Module: TradovE14_KellyPositionSizer.py
...
Key Features:
    ...
    - Risk-adjusted Kelly
    - Integration with existing Tradov risk management

Dependencies:
    - numpy, pandas for data processing
    - scipy for optimization
    - TradovE01_RiskManager for risk limits
...
class MultiAssetKellyResult:
    ...
    sharpe_ratio: float  # Expected Sharpe ratio
    correlation_matrix: np.ndarray | None  # Correlation matrix
    covariance_matrix: np.ndarray | None  # Covariance matrix
...
if __name__ == "__main__":
    ...
    for _i, _weight in enumerate(multi_result.position_weights):
        pass
