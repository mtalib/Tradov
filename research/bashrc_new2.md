🕷️ SPYDER Trading System Environment Loaded
   Connection Mode: gateway (Local IB Gateway)
   Target: 127.0.0.1:4002 (paper)
   Client IDs: 101-108 (Clients 1-8), 100 (Coordinator)
   Run 'ib-check' to verify connectivity
   Run 'ib-switch [gateway|tws]' to change modes
adam@Captova:~$ source ~/.bashrc
🕷️ SPYDER Trading System Environment Loaded
   Connection Mode: gateway (Local IB Gateway)
   Target: 127.0.0.1:4002 (paper)
   Client IDs: 101-108 (Clients 1-8), 100 (Coordinator)
...
echo "   Client IDs: 101-108 (Clients 1-8), 100 (Coordinator)"
