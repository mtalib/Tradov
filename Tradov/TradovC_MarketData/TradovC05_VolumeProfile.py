...
Module: TradovC05_VolumeProfile.py
...
from Tradov.TradovC_MarketData.TradovC01_DataFeed import MarketTick
...
class VolumeProfileAnalyzer:
    ...
    def __init__(self, config: dict | None = None):
        ...
        self.logger = TradovLogger.get_logger("VolumeProfileAnalyzer")
    ...
    def _on_market_data(self, event: Event) -> None:
        ...
        try:
            ...
            # Create market tick
            tick = MarketTick(
                symbol=tick_data.get('symbol', 'TRAD'),
