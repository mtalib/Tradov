...
Series: TradovL_ML
Module: TradovL08_EntryOptimizer.py
...
from Tradov.TradovU_Utilities.TradovU03_DateTimeUtils import TradingCalendar

try:
    from Tradov.TradovL_ML.TradovL10_FeatureEngineering import FeatureEngineer, FeatureSet
except ImportError:
    FeatureEngineer = None  # type: ignore
    FeatureSet = None  # type: ignore

try:
    from Tradov.TradovL_ML.TradovL09_UnifiedRegimeEngine import UnifiedRegimeEngine as RegimeClassifier, RegimeType, MarketRegime  # noqa: E501
except ImportError:
...
class EntryOptimizer:
   ...
   # ==========================================================================
    ...
    def record_execution_slippage(
       ...
       Analysis module (``TradovM05``) and use it to penalise future entry
       ...
       Args:
           ...
           symbol: Underlying symbol (default ``'TRAD'``).
       """
...
if __name__ == "__main__":
   ...
   from TradovL_ML.TradovL10_FeatureEngineering import create_feature_engineer
   from TradovL_ML.TradovL09_UnifiedRegimeEngine import create_unified_regime_engine as create_regime_classifier  # noqa: E501
   ...
   # Test prediction
   from TradovL_ML.TradovL10_FeatureEngineering import FeatureSet
