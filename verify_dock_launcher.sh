...
echo ""
echo "Next steps:"
echo "1. Ensure IB Gateway is running: ~/ibgateway/ibgateway &"
echo "2. Wait 60 seconds for Gateway initialization"
echo "3. Click your Spyder dock icon"
echo "4. Dashboard should show '🟢 IB CONNECTED'"
echo ""
