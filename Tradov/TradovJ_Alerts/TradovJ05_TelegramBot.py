...
Module: TradovJ05_TelegramBot.py
...
class TelegramBot:
    ...
    def start(self) -> None:
        ...
        self.send_system_message("🟢 Tradov Autonomous Trader Started", priority=MessagePriority.HIGH)
    ...
    def stop(self) -> None:
        ...
        self.send_system_message("� Tradov Autonomous Trader Stopped", priority=MessagePriority.HIGH)
        ...
        shutdown_budget_s = float(os.getenv("TRADOV_TELEGRAM_STOP_TIMEOUT_S", "2.5"))
...
"""
        ...
        message += f"\n\n{self.emojis['robot']} <i>Tradov Trading System</i>"
...
<b>TRAD:</b> ${spy_price:.2f} {trend_emoji}
...
"""
    ...
    def send_confirmation_request(
        ...
        approve_data = f"tradov_approve_{order_id}"
        reject_data = f"tradov_reject_{order_id}"
    ...
    def _handle_status_command(
        ...
        kill_lock = Path.home() / ".tradov_kill_lock"
    ...
    def _register_event_handlers(self) -> None:
        ...
        def _subscribe(event_type: EventType, handler: Any, subscriber_name: str) -> None:
            ...
            try:
                # Primary TradovA05 EventManager signature.
    ...
    def _handle_position_closed_event(self, event: Event) -> None:
        ...
        try:
            ...
            symbol = payload.get("symbol") or payload.get("underlying") or "TRAD"
...
if __name__ == "__main__":
    ...
    bot.send_daily_summary(
        ...
        net_pnl=425,
        win_rate=60.0,
        best_trade={'symbol': 'TRAD 450P', 'pnl': 250},
        worst_trade={'symbol': 'TRAD 460C', 'pnl': -100},
