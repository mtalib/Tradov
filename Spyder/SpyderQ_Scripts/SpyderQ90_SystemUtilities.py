...
Module: SpyderQ90_SystemUtilities.py
...
Module Description:
    ...
    main Spyder system for maintenance and data management operations.
"""
...
BACKUP_DIR = Path(SPYDER_HOME) / "backups"
EXPORT_DIR = Path(SPYDER_HOME) / "exports"
TEMP_DIR = Path(SPYDER_HOME) / "temp"
