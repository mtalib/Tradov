...
# -*- coding: utf-8 -*-
"""
SPYDER - Setup Dual-Mode Bashrc Configuration
This script sets up the dual-mode bashrc that supports both local IB Gateway and Remote TWS
"""
...
# ===============================================================================
# NOTE: Add your actual credentials here
...
# ===============================================================================
# DOCKER ALIASES (General - Docker parts removed per user request)
# ===============================================================================
alias dps='docker ps'
...
# FINAL SETUP
# ===============================================================================
# Display SPYDER status on login (optional - uncomment if wanted)
...
def test_new_configuration():
    """Test the new dual-mode configuration"""

    print("\n🧪 Testing new dual-mode configuration...")

    # Test gateway mode
    print("\n📋 Testing Gateway Mode:")
    os.environ["IB_CONNECTION_MODE"] = "gateway"

    # Source the new bashrc (simulate)
    gateway_vars = {
    ...
    # Test TWS mode
    print("\n📋 Testing TWS Mode:")
    os.environ["IB_CONNECTION_MODE"] = "tws"
    ...
    for key, value in tws_vars.items():
        print(f"   {key}={value}")
...
def show_usage_instructions():
    """Show how to use the new dual-mode configuration"""

    print("\n" + "=" * 60)
    print("🎯 DUAL-MODE BASHRC CONFIGURATION")
    print("=" * 60)
...
def main():
    ...
    print("🕷️ SPYDER - Dual-Mode Bashrc Configuration Setup")
    print("=" * 60)
    print("This script sets up flexible bashrc configuration supporting:")
    ...
    print("\n[Step 3] Testing new configuration...")
