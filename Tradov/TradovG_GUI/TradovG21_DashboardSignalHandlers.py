#!/usr/bin/env python3
"""Signal-handler helpers for TradovG05_TradingDashboard.

Series: TradovG_GUI
Module: TradovG21_DashboardSignalHandlers.py
Purpose: Extract slot/controller signal handling out of TradovG05_TradingDashboard
"""
