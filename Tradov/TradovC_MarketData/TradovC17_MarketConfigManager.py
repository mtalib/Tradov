...
Module: TradovC17_MarketConfigManager.py
...
from Tradov.TradovA_Core.TradovA05_EventManager import Event, EventManager, EventType
# ==============================================================================
# LOCAL IMPORTS
# ==============================================================================
from Tradov.TradovU_Utilities.TradovU01_Logger import TradovLogger
from Tradov.TradovU_Utilities.TradovU02_ErrorHandler import TradovErrorHandler
from Tradov.TradovU_Utilities.TradovU49_SymbolCatalog import build_default_symbol_config
...
class MarketConfigManager:
    ...
    def __init__(
        ...
        self.environment = environment or os.getenv("TRADOV_ENV", DEFAULT_ENVIRONMENT)
