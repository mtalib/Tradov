...
print("  ❌ Same strategy, different Sharpe ratios!")
...
print("  ✅ Perfect consistency across all modules")
...
if penalty_pct > 15:
    ...
    print("  Standard Sharpe OVERESTIMATES risk-adjusted performance")
    print("  Options-adjusted Sharpe is more realistic for options trading")
elif penalty_pct > 5:
    print(f"  MODERATE tail risk ({penalty_pct:.0f}% penalty)")
    print("  Consider both standard and adjusted Sharpe")
else:
    print(f"  MINIMAL adjustment ({penalty_pct:.0f}% penalty)")
    print("  Returns are relatively normal-like")
...
if penalty_pct > 15:
    print(f"  - Significant tail risk detected ({penalty_pct:.0f}% penalty)")
    print("    → Recommendation: Consider tighter stop losses")
