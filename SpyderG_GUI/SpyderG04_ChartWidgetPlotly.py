...
Series: SpyderG_GUI
Module: SpyderG04_ChartWidgetPlotly.py
Purpose: High-performance Plotly-based charts with WebEngine for Ubuntu/Wayland compatibility
Author: Mohamed Talib
Year Created: 2025
Last Updated: 2025-09-27 Time: 14:30:00

Module Description:
    This module provides high-performance interactive financial charts using Plotly
    embedded via PySide6's QWebEngineView. This approach offers superior Wayland
    compatibility, smooth interactions, and excellent financial charting capabilities
    while maintaining compatibility with the existing dashboard interface.
