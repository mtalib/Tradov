...
# NEWS SENTINEL AGENT
# ==============================================================================
class TradovY06_NewsSentinelAgent(BaseAutoAgent):
...
# FACTORY
# ==============================================================================
def create_news_sentinel_agent(**kwargs: Any) -> TradovY06_NewsSentinelAgent:
    """Factory function for creating the NewsSentinel agent."""
    return TradovY06_NewsSentinelAgent(**kwargs)
