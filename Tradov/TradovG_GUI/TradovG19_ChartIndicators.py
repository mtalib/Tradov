...
Module Description:
    ...
    Extracted from TradovG05_TradingDashboard.update_chart() per the
    2026-04-15 separation-of-concerns audit (§3):

        "These are indicator calculations, not rendering. They belong
         wherever the rest of TRADOV's technical analysis lives."

    These functions have no Qt dependency and are unit-testable without a
    display. TradovG05 calls compute_chart_indicators() and receives a
