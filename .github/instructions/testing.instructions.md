---
description: "Use when editing pytest tests, conftest bootstrap logic, or test helpers in Tradov. Covers repo markers, focused validation, bootstrap pollution, and narrow stubbing practices."
applyTo:
  - "Tradov/TradovT_Testing/**/*.py"
  - "conftest.py"
---
# Testing Guidelines
...
- Be careful with bootstrap stubs: do not force-replace `Tradov.*` modules in `sys.modules` unless the real import truly fails, and always restore polluted entries in teardown or cleanup.
