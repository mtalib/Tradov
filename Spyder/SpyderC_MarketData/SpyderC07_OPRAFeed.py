...
class OPRADataFeed:
    ...
    def __init__(self, config: dict | None = None):
        ...
        self.ib_client: IBClient | None = None
    ...
    def _update_option_chains(self) -> None:
        ...
        with self._lock:
            for symbol in self.option_chains:
                ...
                for _contract_symbol, quote in self.quotes_cache.items():
    ...
    def _calculate_implied_volatility(self, quote: OptionQuote, underlying_price: float) -> float | None:
    ...
    def _stop_market_data_requests(self) -> None:
        ...
        if self.ib_client:
            for req_id in self.active_contracts:
                try:
    ...
    # PUBLIC API METHODS
    # ==========================================================================
    def get_option_chain(self, symbol: str, expiration: date) -> OptionsChainSnapshot | None:
        """
    ...
    def get_options_flow(self, symbol: str) -> OptionsFlow | None:
        """
...
# MODULE FUNCTIONS
# ==============================================================================
def get_opra_feed(config: dict | None = None) -> OPRADataFeed:
    """
...
# ==============================================================================
# Global instance
_opra_feed_instance: OPRADataFeed | None = None
