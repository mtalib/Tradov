...
# ==============================================================================
try:
    from PySide6.QtCore import QObject, QThread, QTimer, Signal, QMutex, QMutexLocker  # noqa: F401
...
class DashboardDataBridge(QObject if PYSIDE6_AVAILABLE else object):
    ...
    def __init__(self):
        ...
        self.spyder_client: SpyderClient | None = None
        ...
        self.data_export_timer: QTimer | None = None
    ...
    # LIFECYCLE METHODS
    # ==========================================================================
    def initialize(self, spyder_client: SpyderClient | None = None) -> bool:
        """
...
# ==============================================================================
_bridge_instance: DashboardDataBridge | None = None
_bridge_lock = threading.Lock()

def get_dashboard_bridge(spyder_client: SpyderClient | None = None) -> DashboardDataBridge:
    """
