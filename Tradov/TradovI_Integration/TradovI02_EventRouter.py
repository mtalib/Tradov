...
Module: TradovI02_EventRouter.py
...
class EventRouter:
    """
    Intelligent event routing system for TRADOV integration.
    ...
    - Integration with TRADOV ecosystem components
        ...
        try:
            default_rules = [
                ...
                RoutingRule(
                    ...
                    pattern="*.critical.*",
                    target_modules=["TradovM01_SystemMonitor", "TradovJ01_AlertManager"],
                ...
                RoutingRule(
                    ...
                    pattern="trading.*",
                    target_modules=["TradovE01_RiskManager", "TradovE03_GreekLimitsManager"],
                    strategy=RoutingStrategy.BROADCAST,
                    priority=90
                ),
                ...
                RoutingRule(
                    ...
                    pattern="strategy.*",
                    target_modules=["TradovP01_PortfolioManager"],
                ...
                RoutingRule(
                    ...
                    pattern="error.*",
                    target_modules=["TradovU02_ErrorHandler", "TradovJ01_AlertManager"],
                    strategy=RoutingStrategy.BROADCAST,
                    priority=95
                ),
                ...
                RoutingRule(
                    ...
                    pattern="market.*",
                    target_modules=["TradovF04_VolatilityAnalysis", "TradovF10_MarketRegimeDetector"],  # noqa: E501
