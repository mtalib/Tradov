...
Module Description:
    ...
    This module was renumbered from TradovG04_ChartWidgetPlotly.py as part of the
...
Change Log:
    2025-10-15 (v1.6.0):
        - Renumbered from TradovG04_ChartWidgetPlotly.py to TradovG29_ChartWidgetPlotly.py
...
class PlotlyChartWidget(QWidget):
    ...
    def __init__(self, symbol: str = "TRAD", parent=None):
    ...
    def load_sample_data(self):
        ...
        base_price = 585.0  # TRAD approximate price
...
if __name__ == "__main__":
    ...
    chart.setWindowTitle("Tradov Plotly Chart Widget Test")
