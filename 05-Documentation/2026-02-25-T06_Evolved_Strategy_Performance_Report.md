...
> Pricing generated with **QuantLib** (analytic Black-Scholes engine). Institutional libraries: 4/8 available.
...
| Institutional Options Pricing | `SpyderU20_InstitutionalLibraries` | Operational (4/8 libs) |
...
| PyFolio | Not Installed | Portfolio analytics & tear sheets |
| RiskFolio-Lib | Not Installed | Portfolio optimization |
| Stable-Baselines3 | Not Installed | Reinforcement learning |
...
1. **Install QuantLib** (`pip install quantlib-python`) to enable advanced pricing models (Heston, local vol)
2. **Install PyFolio** (`pip install pyfolio-reloaded`) for full tear sheet generation
3. **Run paper trading validation** with the evolved strategy parameters on Tradier sandbox
