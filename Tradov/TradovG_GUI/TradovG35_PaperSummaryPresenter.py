...
Series: TradovG_GUI
Module: TradovG35_PaperSummaryPresenter.py
...
from Tradov.TradovG_GUI.TradovG34_AccountCapitalMath import BuyingPowerUsage
    ...
    *,
    ...
    return [
        ...
        PortfolioSummaryRow(
            ...
            explanation="At-the-money implied volatility of TRAD options",
        ...
        PortfolioSummaryRow(
            ...
            explanation="Portfolio net delta: directional exposure per $1 TRAD move",
