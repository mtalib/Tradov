...
Module: SpyderM08_HealthEndpoint.py
...
Usage::
    ...
    from SpyderM_Monitoring.SpyderM08_HealthEndpoint import HealthEndpoint
...
Environment variables:
    SPYDER_HEALTH_PORT   — override default port (default: 8888)
    SPYDER_HEALTH_HOST   — bind address (default: 127.0.0.1)
"""
...
# CONSTANTS
# ==============================================================================
DEFAULT_HOST: str = os.getenv("SPYDER_HEALTH_HOST", "127.0.0.1")
DEFAULT_PORT: int = int(os.getenv("SPYDER_HEALTH_PORT", "8888"))
...
class _HealthHandler(BaseHTTPRequestHandler):
    ...
    # Silence default request log (endpoint uses SpyderLogger)
...
class HealthEndpoint:
    ...
    Args:
        host: Bind address (default: ``SPYDER_HEALTH_HOST`` env or ``127.0.0.1``).
        port: TCP port (default: ``SPYDER_HEALTH_PORT`` env or ``8888``).
    """
