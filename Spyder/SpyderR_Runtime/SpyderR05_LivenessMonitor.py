...
Module: SpyderR05_LivenessMonitor.py
...
Module Description:
    ...
    heartbeat to two channels:
      ...
      1. A JSON heartbeat file (default: ~/.spyder_heartbeat) refreshed every
         HEARTBEAT_INTERVAL seconds. Q24 ProductionWatchdog consumes this file
         and alerts if it goes stale.

      2. A loopback HTTP server bound to 127.0.0.1:$SPYDER_HEALTHZ_PORT
...
DEFAULT_HEARTBEAT_PATH = str(Path.home() / ".spyder_heartbeat")
...
class LivenessMonitor:
    ...
    def __init__(
        ...
        self._healthz_port = int(
            ...
            else os.environ.get("SPYDER_HEALTHZ_PORT", DEFAULT_HEALTHZ_PORT)
        )
