...
class MaxLossProtection:
    ...
    def update_pnl(
        self,
        total_pnl: float,
        position_pnl: Optional[Dict[str, float]] = None,
...
# FACTORY FUNCTION
# ==============================================================================
def create_max_loss_protection(config: Optional[Dict[str, Any]] = None) -> MaxLossProtection:
...
if __name__ == "__main__":
    ...
    print("\n" + "="*60)
    print("MAX LOSS PROTECTION SYSTEM TEST")
    print("="*60)
    ...
    for pnl in test_pnls:
        ...
        print(f"  New Positions: {status.new_positions_allowed}")
