...
Module: TradovM04_TradingMetrics.py
...
class TradingMetrics:
    ...
    def get_current_metrics(self, period: MetricPeriod = MetricPeriod.REAL_TIME) -> MetricsSnapshot:
        ...
        if period in self._cached_metrics:
            cache_age = datetime.now(UTC) - self._cache_timestamp.get(period, datetime.min)
        ...
        self._cache_timestamp[period] = datetime.now(UTC)
    ...
    def _clean_old_data(self):
        ...
        cutoff_equity = datetime.now(UTC) - timedelta(days=365)
