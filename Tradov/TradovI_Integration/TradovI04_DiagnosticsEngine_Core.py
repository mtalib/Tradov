...
Module: TradovI04_DiagnosticsEngine_Core.py
...
from Tradov.TradovU_Utilities.TradovU15_PerformanceMetrics import (
...
from Tradov.TradovI_Integration.TradovI09_DiagnosticsEngine_HealthChecks import (
    HealthCheckManager,
)
from Tradov.TradovI_Integration.TradovI08_DiagnosticsEngine_DataCollector import DataCollector
from Tradov.TradovI_Integration.TradovI05_DiagnosticsEngine_Analyzers import AnalysisManager
from Tradov.TradovI_Integration.TradovI11_DiagnosticsEngine_Utils import DiagnosticUtils
...
class DiagnosticsEngine:
    """
    Core diagnostics engine for TRADOV ecosystem health monitoring.
    ...
    def __init__(self, config: dict[str, Any] | None = None):
        ...
        if HUB_AVAILABLE:
            ...
            if hub:
                hub.register_module(self, dependencies=["TradovI01_IntegrationHub"])
