...
class SpyderIBTestSuite:
    ...
    def test_module_imports(self):
        ...
        try:
            from SpyderI15_IBTradingInterface import IBTradingInterface, create_trading_interface, SpyderOptionContract
    ...
    def test_trading_interface(self):
        ...
        try:
            from SpyderI15_IBTradingInterface import SpyderSpyderOptionContract, OptionType, get_spy_expiry_dates
            
            # Test option contract creation
            test_option = SpyderSpyderOptionContract(
                symbol="SPY",
                expiry="20250117",
                strike=450.0,
