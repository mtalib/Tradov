...
REGISTERED_MODULES: dict[str, ModuleRecord] = {
    ...
    "N01": ModuleRecord("N01", "TradovN_OptionsAnalytics", "TradovN01_OptionsPricer",
                        "OptionsPricer",
                        "BSM and binomial options pricing", "N",
                        tags=["options", "pricing"]),
    "N04": ModuleRecord("N04", "TradovN_OptionsAnalytics", "TradovN04_OptionsGreeksCalculator",
                        "OptionsGreeksCalculator",
                        "High-precision Greeks (delta, gamma, theta, vega…)", "N",
                        tags=["options", "greeks"]),
    "N09": ModuleRecord("N09", "TradovN_OptionsAnalytics", "TradovN09_GammaExposure",
                        "GammaExposure",
