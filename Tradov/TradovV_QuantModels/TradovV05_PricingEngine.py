...
# ==============================================================================
class TradovPricingEngine:
    """
    Consolidated options pricing engine for Tradov trading system.
    ...
    def __init__(
        ...
        self.logger.info("TradovPricingEngine initialized successfully")
    ...
    def _is_cache_valid(self, result: PricingResult) -> bool:
        ...
        age_seconds = (datetime.now(UTC) - result.calculation_time).total_seconds()
    ...
    async def shutdown(self):
        ...
        self.price_cache.clear()
        self.logger.info("TradovPricingEngine shutdown complete")
...
def create_pricing_engine(
    ...
    """Factory function to create TradovPricingEngine."""
    return TradovPricingEngine(config, data_manager)
