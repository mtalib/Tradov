...
Module: SpyderF19_AnchoredVWAP.py
...
class AnchoredVWAPCalculator:
    ...
    Example:
        ...
        >>> analysis = calc.analyze(data, symbol="SPY")
    ...
    def _detect_swing_points(
        ...
        swing_high = {
            'timestamp': swing_high_idx if isinstance(swing_high_idx, datetime) else datetime.now(),
        ...
        swing_low = {
            'timestamp': swing_low_idx if isinstance(swing_low_idx, datetime) else datetime.now(),
    ...
    def _detect_volume_spike(
        ...
        return AnchorPoint(
            ...
            timestamp=spike_idx if isinstance(spike_idx, datetime) else datetime.now(),
    ...
    def _detect_gap(
        ...
        return AnchorPoint(
            ...
            timestamp=gap_idx if isinstance(gap_idx, datetime) else datetime.now(),
    ...
    def analyze(
        ...
        primary_vwap = self._create_vwap_level_from_df(
            ...
            AnchorPoint(
                ...
                timestamp=df.index[0] if isinstance(df.index[0], datetime) else datetime.now(),
