...
# Version mappings
VERSION_MIGRATIONS = {
    "TWS_MAJOR_VRSN": {"old": ["1012", "1039", "1040"], "new": "1037"},
    "IB_GATEWAY_DIR": {
        "old": ["ibgateway/10.39", "ibgateway/1012", "ibgateway/1040"],
        "new": "ibgateway/1037",
    },
    "IB_GATEWAY_VERSION": {"old": ["10.39", "10.12", "10.40"], "new": "10.37"},
}
    ...
    def run_migration(self) -> bool:
        ...
        if success:
            ...
            if not self.dry_run:
                ...
                self.logger.info(
                    "3. Download IB Gateway 10.39 if not already installed"
                )
