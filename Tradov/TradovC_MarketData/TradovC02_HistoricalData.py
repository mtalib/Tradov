...
Module Description:
    ...
    for the Tradov trading system. Includes caching mechanisms to minimize API calls
...
from Tradov.TradovU_Utilities.TradovU10_TradingCalendar import TradingCalendar  # noqa: E402
from Tradov.TradovA_Core.TradovA05_EventManager import EventManager, Event, EventType  # noqa: E402

# B01_TradovClient removed (legacy broker) — Tradier via TradovB40_TradierClient
TradovClient = None  # type: ignore
...
CACHE_DIR = Path.home() / ".tradov" / "cache" / "historical"
...
class HistoricalDataManager:
    ...
    def __init__(self, ib_client: TradovClient, event_manager: EventManager):
        """
        Initialize Historical Data Manager.

        Args:
            ib_client: Connected TradovClient instance (legacy parameter name)
    ...
    def request_historical_data(
        ...
        if not ENABLE_HISTORICAL_DATA:
            ...
            self.logger.warning(
                ...
                f"To enable: Set ENABLE_HISTORICAL_DATA = True in TradovC02_HistoricalData.py"
            )
