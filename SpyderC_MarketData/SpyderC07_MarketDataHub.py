...
UPDATE_TIERS = {
    ...
    'HIGH': {
        'symbols': ['VIX9D', 'VXV', 'VXMT', 'VVIX', 'UVXY', 'TRIN-NYSE', 'ADD-NYSE', 
    ...
    'MEDIUM': {
        'symbols': ['VXST', 'VXN', 'RVX', 'CPCE', 'CPCI', 'TICK-NASDAQ', 'TRIN-NASDAQ',
...
class MarketDataHub:
    ...
    def _on_tick_option(self, req_id: int, tick_type: int, tick_attrib: int,
    ...
    def _handle_disconnection(self):
        ...
        self.logger.info(f"Attempting reconnection {self.reconnect_attempts}/{MAX_RECONNECT_ATTEMPTS} in {delay}s")
        time.sleep(delay)
