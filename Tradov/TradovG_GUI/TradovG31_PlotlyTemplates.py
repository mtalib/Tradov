...
Module: TradovG31_PlotlyTemplates.py [Application Name][Group Letter] [Module Number]_[Purpose].py
...
Module Description:
    Templates for Plotly charts in the Tradov Trading Dashboard. Provides
    ...
    and options-specific overlays. All templates match the Tradov dashboard dark
    theme and provide superior interactivity for trading analysis.

    This module was renumbered from TradovG04_PlotlyTemplates.py as part of the
...
Change Log:
    2025-10-15 (v1.6.0):
        - Renumbered from TradovG04_PlotlyTemplates.py to TradovG31_PlotlyTemplates.py
...
class CandlestickChartTemplate:
    ...
    def create_basic_candlestick(
        df: pd.DataFrame, symbol: str = "TRAD", height: int = 600
    ) -> go.Figure:
...
def apply_tradov_theme(fig: go.Figure) -> go.Figure:
    """Apply consistent Tradov theme to any Plotly figure."""
