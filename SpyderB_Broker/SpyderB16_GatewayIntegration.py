...
class GatewayIntegrationManager(QObject):
    ...
    dashboard_update = pyqtSignal(dict)  # Emits dashboard data
    system_log_update = pyqtSignal(str)  # Emits log entries
    alert_signal = pyqtSignal(str, str)  # Emits (severity, message)
...
class DashboardIntegrationHelper:
    """Helper class for easy PyQt6 dashboard integration"""
    ...
    def connect_to_dashboard(self, dashboard_widget):
        ...
        Args:
            dashboard_widget: PyQt6 dashboard widget with update methods
        """
        # Connect signals
