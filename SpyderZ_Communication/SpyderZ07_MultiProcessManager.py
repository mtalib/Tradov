...
from SpyderZ02_MessageProtocol import (
    MessageCategory, SystemStatusMessage, HeartbeatMessage,
...
class MultiProcessManager:
    ...
    def __init__(self):
        ...
        # Shared memory
        self.shared_mem: Optional[shared_memory.SharedMemory] = None
        self.tick_buffer: Optional[np.ndarray] = None
...
_manager_instance: Optional[MultiProcessManager] = None
...
if __name__ == "__main__":
    ...
    if manager.initialize():
        print("✅ MultiProcessManager initialized")
        ...
        try:
            ...
            for i in range(10):
                ...
                for engine, info in status.items():
                    print(f"  {engine}: {info['state']} (PID: {info['pid']})")
                ...
                if manager.write_tick_data(tick):
                    print(f"  Wrote tick: SPY @ {tick.last}")
