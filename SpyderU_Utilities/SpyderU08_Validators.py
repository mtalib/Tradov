...
def is_valid_list(value: Any, min_length: int = 0,
...
def is_valid_dict(value: Any, required_keys: Optional[List[str]] = None,
...
# ==============================================================================
def is_valid_date(value: Any, min_date: Optional[date] = None,
...
def is_valid_datetime(value: Any, min_dt: Optional[datetime] = None,
                     max_dt: Optional[datetime] = None) -> bool:
    """
...
def is_valid_price(value: Any, min_price: float = MIN_PRICE,
                  max_price: float = MAX_PRICE) -> bool:
    """
...
def is_valid_quantity(value: Any, allow_fractional: bool = False) -> bool:
    ...
    """
    if allow_fractional:
        return is_valid_number(value, MIN_QUANTITY, MAX_QUANTITY, 
...
def is_valid_percentage(value: Any, min_pct: float = 0.0,
...
def validate_config_value(key: str, value: Any, schema: Dict[str, Any]) -> Tuple[bool, Optional[str]]:
    """
            ...
            for param, validator in validators.items():
                if param in bound.arguments:
                    ...
                    if not validator(value):
                        raise ValidationError(param, value, 
