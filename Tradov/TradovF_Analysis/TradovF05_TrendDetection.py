...
Module: TradovF05_TrendDetection.py
...
class MultiTimeframeTrend:
    ...
    micro: TrendResult | None = None
    short: TrendResult | None = None
    medium: TrendResult | None = None
    long: TrendResult | None = None
    macro: TrendResult | None = None
...
class TrendDetector:
    ...
    def _find_trend_bounds(self, data: pd.DataFrame,
                         direction: TrendDirection) -> tuple[datetime | None, timedelta | None]:
...
if __name__ == "__main__":
    ...
    for _change in changes[-5:]:  # Last 5 changes
        pass
