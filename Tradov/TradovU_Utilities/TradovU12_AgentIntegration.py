...
Module: TradovU12_AgentIntegration.py
...
class AgentRegistry:
    """
    Thread-safe registry for all Tradov X- and Y-series agents.

    Example usage (from any agent module)::

        from Tradov.TradovU_Utilities.TradovU12_AgentIntegration import get_registry, AgentSeries
