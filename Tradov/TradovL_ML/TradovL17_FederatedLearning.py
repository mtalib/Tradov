...
Series: TradovL_ML
Module: TradovL17_FederatedLearning.py
...
class FederatedClient:
    ...
    def __init__(self, config: ClientConfig):
        self.config = config
        self.logger = TradovLogger.get_logger(f"FederatedClient_{config.client_id}")
...
class FederatedCoordinator:
    ...
    def __init__(self, config: dict[str, Any] | None = None):
        self.logger = TradovLogger.get_logger("FederatedCoordinator")
        self.error_handler = TradovErrorHandler()
    ...
    def initialize_global_model(self, model_type: ModelType, architecture: nn.Module):
        ...
        federated_model = FederatedModel(
            ...
            metadata={"created": datetime.now(UTC), "coordinator_id": "main"},
        )
...
class FederatedLearningManager:
    ...
    def __init__(self):
        self.logger = TradovLogger.get_logger("FederatedLearningManager")
