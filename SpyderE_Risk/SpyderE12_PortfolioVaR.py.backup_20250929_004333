...
Spyder Version: 1.0
Module: SpyderE12_PortfolioVaR.py
...
STRESS_SCENARIOS = {
    'BLACK_MONDAY': {'SPY': -0.20, 'VIX': 2.5, 'correlation': 1.0},
    'FLASH_CRASH': {'SPY': -0.09, 'VIX': 1.8, 'correlation': 0.9},
    'COVID_CRASH': {'SPY': -0.12, 'VIX': 3.0, 'correlation': 0.95},
    'LEHMAN': {'SPY': -0.15, 'VIX': 2.2, 'correlation': 0.85},
    'TAPER_TANTRUM': {'SPY': -0.06, 'VIX': 1.5, 'correlation': 0.7},
    'RATE_SHOCK': {'SPY': -0.08, 'rates': 0.5, 'correlation': 0.6}
}
