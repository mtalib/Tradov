...
class PositionGroupValidator:
    ...
    def validate_position_group(self, position_group: PositionGroup) -> ValidationReport:
        ...
        with self._lock:
            ...
            try:
                ...
                position_group.last_validated = datetime.now(UTC)
    ...
    def _calculate_validation_metrics(self, position_group: PositionGroup) -> dict[str, float]:
        ...
        # Time metrics
        min_dte = min((leg.expiration - datetime.now(UTC)).days for leg in position_group.legs)
...
if __name__ == "__main__":
    ...
    iron_condor_legs = [
        ...
        PositionLeg(
            ...
            strike=380,
            expiration=datetime.now(UTC) + timedelta(days=45),
            entry_price=0.50,
            current_price=0.45,
