...
Module: SpyderG30_PlotlyDataBridge.py [Application Name][Group Letter] [Module Number]_[Purpose].py
Purpose: Data bridge for Plotly charts
Author: Mohamed Talib
Year Created: 2025
Last Updated: 2025-10-15 Time: 22:21:00

Module Description:
    Data bridge for Plotly charts in the Spyder Trading Dashboard. Provides a
    data bridge that converts Spyder's market data format to Plotly-compatible JSON
    ...
    This module was renumbered from SpyderG04_PlotlyDataBridge.py as part of the
...
Change Log:
    2025-10-15 (v1.6.0):
        - Renumbered from SpyderG04_PlotlyDataBridge.py to SpyderG30_PlotlyDataBridge.py
