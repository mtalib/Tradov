...
SYSTEM_DESCRIPTION = "Autonomous TRAD Options Trading System with Research Enhancements"
...
# Machine Learning performance - NEEDED BY TradovL_ML modules
...
def validate_constants():
    ...
    positive_int_constants = [
        ...
        ('TRAD_CONTRACT_MULTIPLIER', TRAD_CONTRACT_MULTIPLIER),
...
__all__ = [
    ...
    # Trading constants
    "PRIMARY_SYMBOL", "OPTION_MULTIPLIER", "TRAD_CONTRACT_MULTIPLIER",
