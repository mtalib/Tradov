...
try:
    ...
    from ibapi.common import TickerId, TickType
...
class SPYOptionsChainManager:
    ...
    # OPTIONS CHAIN MANAGEMENT
    # ==========================================================================
    def subscribe_to_chain(self, chain_type: OptionsChainType, 
                          callback: Callable[[OptionsChain], None]) -> bool:
        """
    ...
    def get_atm_options(self, chain_type: OptionsChainType) -> Tuple[Optional[OptionsContract], Optional[OptionsContract]]:
        """
                ...
                for chain_type, chain in self.active_chains.items():
                    if chain.expiration < today:
                        ...
                        if new_expiration:
                            ...
                            self.logger.info(f"Created new {chain_type.value} chain for {new_expiration}")
    ...
    def _create_options_contract(self, expiration: date, strike: float, 
                               option_type: OptionType, chain_type: OptionsChainType) -> Optional[OptionsContract]:
    ...
    def _subscribe_to_chain_data(self, chain: OptionsChain) -> None:
        ...
        try:
            ...
            self.logger.info(f"Subscribing to {chain.chain_type.value} chain: "
