...
Module: TradovJ02_EmailNotifier.py
...
class EmailConfig:
    ...
    from_address: str
    from_name: str = "Tradov Trading System"
...
class EmailNotifier:
    ...
    def send_trade_notification(
        ...
        context = {
            ...
            'system_name': 'Tradov Trading System'
        }
    ...
    def _create_default_templates(self) -> None:
        ...
        <body style="font-family: Arial, sans-serif;">
            ...
            <p>A trade has been executed in your Tradov Trading System:</p>
...
A trade has been executed in your Tradov Trading System:
