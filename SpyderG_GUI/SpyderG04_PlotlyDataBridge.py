...
Series: SpyderG_GUI
Module: SpyderG04_PlotlyDataBridge.py
Purpose: Data bridge for real-time Plotly chart updates via JavaScript
Author: Mohamed Talib
Year Created: 2025
Last Updated: 2025-09-27 Time: 15:00:00

Module Description:
    This module provides a data bridge that converts Spyder's market data format
    to Plotly-compatible JSON and handles real-time updates via JavaScript callbacks.
    It enables smooth streaming of market data to embedded Plotly charts without
    full chart redraws, optimizing performance for live trading dashboards.
"""
...
class PlotlyDataBridge(QObject):
    ...
    This class manages the flow of data from Spyder's market data workers
    ...
    def __init__(self, web_view: QWebEngineView, symbol: str = "SPY"):
        """Initialize the data bridge."""
        super().__init__()

        self.web_view = web_view
        self.symbol = symbol
        self.converter = SpyderToPlotlyConverter()
