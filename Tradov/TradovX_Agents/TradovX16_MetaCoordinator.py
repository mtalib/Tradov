...
Tradov Version: 1.0
Module: TradovX16_MetaCoordinator.py
Group: X (AI Agents)
...
_AGENT_CLASS_REGISTRY: dict[str, tuple[str, str]] = {
    "X01_Greeks":          ("Tradov.TradovX_Agents.TradovX01_GreeksAgent",             "GreeksAgent"),  # noqa: E501
    "X02_Flow":            ("Tradov.TradovX_Agents.TradovX02_FlowAgent",                "FlowAgent"),  # noqa: E501
    "X03_StrategyDirector":("Tradov.TradovX_Agents.TradovX03_StrategyDirectorAgent",   "StrategyDirectorAgent"),  # noqa: E501
    "X04_RiskGuardian":    ("Tradov.TradovX_Agents.TradovX04_RiskGuardianAgent",        "RiskGuardianAgent"),  # noqa: E501
    "X05_MLResearch":      ("Tradov.TradovX_Agents.TradovX05_MLResearchAgent",          "MLResearchAgent"),  # noqa: E501
    "X07_ExecutionStrategy":("Tradov.TradovX_Agents.TradovX07_ExecutionStrategyAgent", "ExecutionStrategyAgent"),  # noqa: E501
    "X08_Performance":     ("Tradov.TradovX_Agents.TradovX08_PerformanceAnalyticsAgent","PerformanceAnalyticsAgent"),  # noqa: E501
    "X09_AlertManager":    ("Tradov.TradovX_Agents.TradovX09_AlertManagerAgent",        "AlertManagerAgent"),  # noqa: E501
    "X10_QuantModels":     ("Tradov.TradovX_Agents.TradovX10_QuantModelsAgent",         "QuantModelsAgent"),  # noqa: E501
    "X11_Sentiment":       ("Tradov.TradovX_Agents.TradovX11_SentimentAnalysisAgent",   "SentimentAnalysisAgent"),  # noqa: E501
    "X12_SystemHealth":    ("Tradov.TradovX_Agents.TradovX12_SystemHealthAgent",        "SystemHealthAgent"),  # noqa: E501
    "X13_MarketAnalysis":  ("Tradov.TradovX_Agents.TradovX13_MarketAnalysisAgent",      "MarketAnalysisAgent"),  # noqa: E501
    "X14_Orchestrator":    ("Tradov.TradovX_Agents.TradovX14_OrchestratorAgent",        "OrchestratorAgent"),  # noqa: E501
    "X15_StrategyGenerator":("Tradov.TradovX_Agents.TradovX15_StrategyGeneratorAgent", "StrategyGeneratorAgent"),  # noqa: E501
}
...
class MetaCoordinator:
    ...
    async def coordinate_decision(
        ...
        try:
            ...
            # Update metrics
            decision_time = (datetime.now(UTC) - start_time).total_seconds()
    ...
    def update_agent_performance(self, agent_id: str, was_correct: bool, return_contribution: float):  # noqa: E501
        ...
        perf.last_update = datetime.now(UTC)
...
if __name__ == "__main__":
    ...
    async def test_coordinator():
        ...
        # Test market data
        market_data = {
            'TRAD': {'price': 450.0, 'volume': 1000000},
            'VIX': {'level': 18.5},
