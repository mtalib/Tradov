...
class TradingCalendar:
    ...
    def is_extended_hours(self, timestamp: Optional[datetime] = None) -> bool:
        ...
        try:
            ...
            # Check premarket
            if hours.premarket_open and current_time >= hours.premarket_open and current_time < hours.market_open:
                return True
            
            # Check afterhours
            if hours.afterhours_close and current_time > hours.market_close and current_time <= hours.afterhours_close:
                return True
    ...
    def get_market_session(self, timestamp: Optional[datetime] = None) -> MarketSession:
        ...
        try:
            ...
            elif hours.premarket_open and current_time >= hours.premarket_open and current_time < hours.market_open:
                return MarketSession.PREMARKET
            elif hours.afterhours_close and current_time > hours.market_close and current_time <= hours.afterhours_close:
    ...
    def _add_fixed_holidays(self, year: int):
        ...
        self._add_holiday(self._get_nth_weekday_of_month(year, 1, 0, 3), "Martin Luther King Jr. Day")
