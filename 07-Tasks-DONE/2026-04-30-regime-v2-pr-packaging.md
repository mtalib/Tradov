...
- Command: /home/adam/Projects/Tradov/.venv/bin/python -m pytest Tradov/TradovT_Testing -q
...
- Command: /home/adam/Projects/Tradov/.venv/bin/python -m pytest Tradov/TradovT_Testing/TradovT184_RegimeV2DeterministicContract.py -q -o addopts=''
- Result: 8 passed
...
- Trackable code file in scope:
   - Tradov/TradovT_Testing/TradovT184_RegimeV2DeterministicContract.py (new)
...
1. Stage only scope file:
   git add Tradov/TradovT_Testing/TradovT184_RegimeV2DeterministicContract.py
