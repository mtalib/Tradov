...
Module Description:
    ...
    accurate ET time using TradovU03's trading hours infrastructure. No design
...
from Tradov.TradovU_Utilities.TradovU03_DateTimeUtils import US_EASTERN
...
def get_et_time_string(include_timezone: bool = True) -> str:
    ...
    try:
        ...
        return datetime.now(UTC).strftime(SIMPLE_TIME_FORMAT)
