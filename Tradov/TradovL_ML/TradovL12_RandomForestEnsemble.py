...
Series: TradovL_ML
Module: TradovL12_RandomForestEnsemble.py
...
class TradovRandomForestEnsemble:
    """
    ...
    async def train(
        ...
        self.performance_history.append(
            {"strategy": strategy_type, "timestamp": datetime.now(UTC), "performance": performance}
        )
        logger.info(
...
async def main():
    ...
    # Initialize ensemble
    rf_ensemble = TradovRandomForestEnsemble()
