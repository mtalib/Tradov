...
class BlackSwanValidator:
    ...
    def run_full_validation(self, test_types: list[TestType] | None = None) -> ValidationReport:
        """
    ...
    def _run_test_suite(self, test_class, test_type: TestType):
        ...
        runner = unittest.TextTestRunner(verbosity=0, stream=open(os.devnull, 'w'))  # noqa: SIM115
    ...
    def _generate_recommendations(self) -> list[str]:
        ...
        if stress_tests:
            ...
            if stress_failures:
                recommendations.append(
                    "⚠️ System may not handle extreme conditions well"
                )
...
if __name__ == "__main__":
    ...
    print("\nReports saved to:")
    print("  - black_swan_validation_report.json")
    print("  - black_swan_validation_report.txt")
