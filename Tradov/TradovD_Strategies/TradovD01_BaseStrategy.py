...
Module: TradovD01_BaseStrategy.py
...
from Tradov.TradovU_Utilities.TradovU07_Constants import (MAX_DAILY_TRADES,
...
class BaseStrategy(ABC):
    ...
    def check_exit(self, position: Any) -> Any:
        ...
        Called once per sweep cycle by ``TradovR14_ExitMonitor._check_position``.
