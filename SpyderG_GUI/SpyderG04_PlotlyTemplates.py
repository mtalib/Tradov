...
Series: SpyderG_GUI
Module: SpyderG04_PlotlyTemplates.py
Purpose: Reusable Plotly chart templates for financial visualization
Author: Mohamed Talib
Year Created: 2025
Last Updated: 2025-09-27 Time: 14:45:00

Module Description:
    This module provides reusable Plotly chart templates optimized for
    quantitative trading visualization. Templates include candlestick charts,
    technical indicators, volume analysis, and options-specific overlays.
    All templates match the Spyder dashboard dark theme and provide
    superior interactivity for trading analysis.
"""
