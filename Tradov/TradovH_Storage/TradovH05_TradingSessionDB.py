...
Module Description:
    ...
    (tradov_live.db) and one for paper trading (tradov_paper.db) — so all
...
LIVE_DB_PATH = Path("data/tradov_live.db")

#: Path to the paper-trading SQLite database.
PAPER_DB_PATH = Path("data/tradov_paper.db")
...
class TradingSessionDB:
    ...
    Usage::
        ...
        paper_db.record_trade(symbol="TRAD", trade_type="STO", side="sell",
    ...
    def record_trade(
        ...
        *,
        ...
        Args:
            symbol:       Instrument ticker (e.g. "TRAD", "TRAD241220P550").
