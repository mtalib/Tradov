...
class SpyderDIXQuickStart:
        ...
        try:
            ...
            if self.config.generate_charts:
                ...
                if chart_path:
                    ...
                    print(
                        f"{SUCCESS_SYMBOL} Component Analysis Chart: {
                    ...
                    try:
                        ...
                        if len(history) > 1:
                            ...
                            if ts_path:
                                ...
                                print(
                                    f"{SUCCESS_SYMBOL} Time Series Chart: {
    ...
    def _print_banner(self) -> None:
        ...
        print("=" * BANNER_WIDTH)
        print(
            "This demo calculates the DIX using "
    ...
    def _display_top_contributors(self, results: Dict) -> None:
        ...
        sorted_breakdown = sorted(
            breakdown.items(), key=lambda x: x[1]["market_cap"], reverse=True
        )[:10]
        ...
        for symbol, data in sorted_breakdown:
            ...
            print(
                f"{symbol:<8} {data['dpi']:<8.4f} {data['weight']:<8.4f} " f"{contribution:<12.6f}"
            )
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--full", action="store_true", help="Use full S&P 500 calculation instead of demo"
    )
    ...
    parser.add_argument(
        "--days", type=int, default=5, help="Days of history for time series (default: 5)"
    )
