...
Module Description:
    ...
    read from environment variables or the Tradov config system.

    Environment variables (any subset may be set):
        TRADOV_SLACK_WEBHOOK_URL   — Slack incoming webhook URL
        TRADOV_TEAMS_WEBHOOK_URL   — Microsoft Teams connector URL
        TRADOV_DISCORD_WEBHOOK_URL — Discord webhook URL
...
# CONSTANTS
# ==============================================================================
_ENV_SLACK   = "TRADOV_SLACK_WEBHOOK_URL"
_ENV_TEAMS   = "TRADOV_TEAMS_WEBHOOK_URL"
_ENV_DISCORD = "TRADOV_DISCORD_WEBHOOK_URL"
...
class WebhookNotifier:
    ...
    Usage::
        ...
        notifier.send(message="TRAD alert fired", severity=Severity.CRITICAL)
    ...
    def _build_discord_payload(
        ...
        embed: dict[str, Any] = {
            ...
            "footer":      {"text": "Tradov Trading System"},
            "timestamp":   _iso_now(),
        }
        if fields:
            embed["fields"] = [
