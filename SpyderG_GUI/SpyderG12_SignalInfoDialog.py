    ...
    def get_signal_content(self) -> dict:
        ...
        signal_contents = {
            ...
            'AI DECISION': {
                ...
                'signal_colors': [
                    {'color': 'positive', 'text': 'Green: Strong directional signal with high confidence'},
                    {'color': 'neutral', 'text': 'Yellow: Neutral or low confidence signal'},
                    {'color': 'negative', 'text': 'Red: Conflicting signals or system recalibration'}
                ],
            ...
            'RSI CONFLUENCE': {
                ...
                'signal_colors': [
                    {'color': 'positive', 'text': 'Green: Oversold confluence (<30 on multiple timeframes)'},
                    {'color': 'neutral', 'text': 'Yellow: Neutral range (30-70)'},
                    {'color': 'negative', 'text': 'Red: Overbought confluence (>70 on multiple timeframes)'}
                ],
            ...
            'RISK TRIGGERS': {
                ...
                'signal_colors': [
                    ...
                    {'color': 'neutral', 'text': 'Yellow: Approaching risk limits (75-90% of threshold)'},
        ...
        return signal_contents.get(self.signal_type, {
