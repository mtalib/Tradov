...
Module: TradovX13_MarketAnalysisAgent.py
...
from Tradov.TradovF_Analysis.TradovF10_MarketRegimeDetector import MarketRegimeDetector
from Tradov.TradovF_Analysis.TradovF05_TrendDetection import TrendDetector
from Tradov.TradovF_Analysis.TradovF02_PriceAction import PriceActionAnalyzer
import logging
...
class MarketData:
    ...
    correlated_assets: dict[str, pd.Series] | None = None
...
# MAIN CLASS
# ==============================================================================
class TradovX13_MarketAnalysisAgent:
    """
    ...
    async def analyze_market(
        ...
        try:
            ...
            if is_tradovx_enabled("USE_AI_MARKET_ANALYSIS") and OLLAMA_AVAILABLE:
...
def create_market_analysis_agent(
    ...
    Returns:
        TradovX13_MarketAnalysisAgent instance
    """
    return TradovX13_MarketAnalysisAgent(model_name, temperature)
...
def get_module_instance() -> TradovX13_MarketAnalysisAgent:
