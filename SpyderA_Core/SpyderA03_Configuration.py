...
class ConfigManager:
    ...
    def __init__(self, config_path: Optional[Path] = None, 
        ...
        self.config_dir = self.config_path.parent if self.config_path.is_file() else self.config_path
    ...
    def _track_config_sources(self, config: Dict[str, Any], source: ConfigSource, 
                            prefix: str = ""):
    ...
    def set(self, key: str, value: Any, source: str = "runtime") -> bool:
        ...
        with self._lock:
            try:
                ...
                encrypted_value = self._encrypt_value(value) if is_sensitive and self.encryption_key else value
    ...
    def export_config(self, output_path: Path, format: ConfigFormat = ConfigFormat.YAML,
