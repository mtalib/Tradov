...
class RatioSetup:
    ...
    unlimited_risk_side: str | None = None  # 'upside' or 'downside'
...
class RatioSpreadsStrategy(BaseStrategy):
    ...
    def _select_ratio_strategy(self, market_conditions: dict[str, Any]) -> RatioStrategy | None:
    ...
    def _check_ratio_suitability(self, iv_rank: float, regime: str) -> bool:
        ...
        return regime not in ['crisis', 'extreme_volatility']
    ...
    def _create_ratio_setup(self, strategy: RatioStrategy,
                           ...
                           conditions: dict[str, Any]) -> RatioSetup | None:
    ...
    def _select_ratio_strikes(self, strategy: RatioStrategy,
                             current_price: float,
                             conditions: dict[str, Any]) -> dict[str, float] | None:
    ...
    def _get_ratio_type(self, ratio: float) -> RatioType:
        ...
        ratio_map = {
            2.0: RatioType.ONE_BY_TWO,
            3.0: RatioType.ONE_BY_THREE,
            1.5: RatioType.TWO_BY_THREE,
        }
        return ratio_map.get(ratio, RatioType.CUSTOM)
    ...
    def _determine_unlimited_risk_side(self, strategy: RatioStrategy) -> str | None:
        """Determine which side has unlimited risk"""
        if strategy == RatioStrategy.PUT_RATIO:
            return 'downside'
        elif strategy == RatioStrategy.CALL_RATIO:
            return 'upside'
        elif strategy == RatioStrategy.CALL_BACKSPREAD or strategy == RatioStrategy.PUT_BACKSPREAD:
    ...
    def _create_jade_lizard_setup(self, market_data: pd.DataFrame,
                                 conditions: dict[str, Any]) -> JadeLizardSetup | None:
