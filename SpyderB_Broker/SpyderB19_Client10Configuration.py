...
if __name__ == "__main__":
    ...
    print(
        f"  GEX: {
            config.gex_config.enabled} (Update: {
            config.gex_config.update_frequency.value}s)"
    )
    print(
        f"  DEX: {
            config.dex_config.enabled} (Update: {
            config.dex_config.update_frequency.value}s)"
    )
    print(
        f"  OGL: {
            config.ogl_config.enabled} (Update: {
            config.ogl_config.update_frequency.value}s)"
    )
    print(
        f"  DIX: {
            config.dix_config.enabled} (Update: {
            config.dix_config.update_frequency.value}s)"
    )
    print(
        f"  SWAN: {
            config.swan_config.enabled} (Update: {
            config.swan_config.update_frequency.value}s)"
    )
    print()
