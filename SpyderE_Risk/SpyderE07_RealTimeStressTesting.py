...
Series: SpyderE_Risk  
Module: SpyderE07_RealTimeStressTesting.py
...
class RealTimeStressTesting:
    ...
    # ==========================================================================
    async def run_single_scenario(self, scenario_id: str, portfolio: PortfolioSnapshot) -> Optional[StressResult]:
        """
    ...
    def _get_last_run_time(self, scenario_id: str) -> Optional[str]:
...
# ==============================================================================
_stress_testing_instance: Optional[RealTimeStressTesting] = None
