...
Concrete satisfiers (no inheritance required):
    IndicatorCalculator (TradovF01) already satisfies AnalyticsProviderProtocol
    structurally via calculate_all_indicators / get_trading_signals.
    MarketRegimeDetector (TradovF10) already satisfies AnalyticsProviderProtocol
    structurally via get_current_regime.
    X-Series agents (X03, X13, X14) satisfy RegimeAwareAgentProtocol structurally.

Usage::

    from Tradov.TradovF_Analysis.TradovF00_AnalysisProtocol import (
