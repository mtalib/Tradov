...
class Scheduler:
    ...
    def _schedule_default_tasks(self):
        ...
        self.add_task(
            ...
            minute="0,5,10",
            day_of_week="mon-fri",
            description="Escalated risk check during TRAD options close window (4:00–4:15 PM ET)"
        )
    ...
    def _on_eod_review(self) -> None:
        ...
        """
        try:
            from Tradov.TradovK_Reports.TradovK02_DailyTradingReport import (
