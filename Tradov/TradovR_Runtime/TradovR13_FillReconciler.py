...
class _TrackedOrder:
    ...
    order_id: str          # internal Tradov order ID
...
class FillReconciler:
    ...
    def track(
        ...
        Args:
            order_id: Internal Tradov order ID.
        ...
        self._inc_counter("tradov_orders_submitted_total")
        self.logger.info(
    ...
    def _poll_one(self, entry: _TrackedOrder) -> None:
        ...
        if raw_status == "filled":
            ...
            self._inc_counter("tradov_fills_detected_total")
            self._em.emit(
