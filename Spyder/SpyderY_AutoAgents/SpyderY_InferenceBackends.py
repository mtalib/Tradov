...
Series: SpyderY_AutoAgents
Module: SpyderY_InferenceBackends.py
Purpose: Pluggable inference backends for SpyderY autonomous agents

Author: Mohamed Talib
Year Created: 2026
Last Updated: 2026-04-04 Time: 18:00:00
...
Description:
    ...
    Backend selection is controlled by a single env var:
        ...
        SPYDER_LLM_BACKEND=openvino    → OpenVINOBackend

    OllamaBackend
    -------------
    Wraps the `ollama` Python SDK.  Model names (e.g. "gemma4:e4b") come
    from OllamaConfig in SpyderY00_BaseAutoAgent and are passed in at
...
class InferenceBackend(ABC):
    """Contract that all SpyderY inference backends must satisfy.
