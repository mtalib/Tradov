...
Module: SpyderS18_EconomicCalendar.py
...
Env vars:
  SPYDER_ECO_STAND_DOWN_BEFORE_MIN   – minutes before event to start stand-down
                                       (default 30)
  SPYDER_ECO_STAND_DOWN_AFTER_MIN    – minutes after event to end stand-down
                                       (default 30)
  SPYDER_ECO_CALENDAR_GATE_ENABLED   – set to "0" to disable the gate
                                       (default "1" — enabled)
...
# Configuration
# ---------------------------------------------------------------------------
_BEFORE_MIN = int(os.getenv("SPYDER_ECO_STAND_DOWN_BEFORE_MIN", "30"))
_AFTER_MIN = int(os.getenv("SPYDER_ECO_STAND_DOWN_AFTER_MIN", "30"))
_GATE_ENABLED = os.getenv("SPYDER_ECO_CALENDAR_GATE_ENABLED", "1") != "0"
