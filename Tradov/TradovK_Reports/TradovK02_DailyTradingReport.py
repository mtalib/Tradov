...
Series: TradovK_Reports
Module: TradovK02_DailyTradingReport.py
...
from Tradov.TradovU_Utilities.TradovU15_PerformanceMetrics import PerformanceCalculator as PerformanceMetrics  # noqa: E501
from Tradov.TradovH_Storage.TradovH01_DataAccessLayer import get_data_access_layer
from Tradov.TradovE_Risk.TradovE06_RiskMetrics import RiskMetricsCalculator
from Tradov.TradovJ_Alerts.TradovJ02_EmailNotifier import EmailNotifier
...
class DailyTradingReport:
    ...
    def _get_market_context(self, report_date: date) -> dict[str, Any]:
        ...
        # Get market data
        market_data = self.dal.get_market_data(date=report_date, symbol='TRAD')
    ...
    def _generate_json_report(self, report_data: DailyReportData) -> str:
        ...
        report_dict['metadata'] = {
            ...
            'version': '1.0',
            'generator': 'TradovK02_DailyTradingReport'
        }
...
<html>
<head>
    <title>Tradov Daily Trading Report - {{ report_date }}</title>
    <style>
        body {
...
<body>
    ...
    <div class="section" style="text-align: center; color: #7f8c8d;">
        <p>Report generated by Tradov Trading System</p>
        <p>© 2025 Tradov Trading. All rights reserved.</p>
    </div>
</body>
</html>
        """
    ...
    def _send_email_report(self, report_data: DailyReportData,
        ...
        try:
            subject = f"Tradov Daily Report - {report_data.report_date} - Net P&L: ${report_data.net_pnl:,.2f}"  # noqa: E501
...
Please find detailed reports attached.
    ...
    def _eod_collect_policy_blocks(
        ...
        kill_lock = _Path.home() / ".tradov_kill_lock"
        if kill_lock.exists():
            try:
    ...
    def generate_weekly_ops_report(
        ...
        lines: list[str] = [
            f"# Tradov Weekly Ops Report — {week_key}",
            "",
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Generate Tradov daily trading report")
