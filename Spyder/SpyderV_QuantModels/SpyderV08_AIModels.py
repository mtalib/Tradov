...
class SpyderAIModels:
    ...
    def __init__(self, config: AIModelsConfig | None = None, data_manager=None):
        self.config = config or AIModelsConfig()
        self.data_manager = data_manager
        self.logger = logging.getLogger(self.__class__.__name__)

        # Model components
        self.transformer_model: TransformerOptionsPricer | None = None
        self.rl_agent: PolicyNetwork | None = None
    ...
    async def train_models(self,
        ...
        try:
            ...
            self.training_state['last_training_date'] = datetime.now(UTC)
...
# FACTORY FUNCTION
# ==============================================================================
def create_ai_models_engine(config: dict[str, Any] | None = None,
