...
class OrderBook:
    ...
    def get_weighted_mid_price(self, depth: int = 1) -> Optional[float]:
...
class TradeEvent:
    ...
    # Context
    pre_trade_spread: Optional[float] = None
    post_trade_spread: Optional[float] = None
...
class MarketMicrostructureEngine:
    ...
    def __init__(self):
        ...
        self.model_validator: Optional[ModelValidationEngine] = None
    ...
    def reconstruct_order_book(self, symbol: str, 
                              timestamp: Optional[datetime] = None) -> Optional[OrderBook]:
        """
...
# ==============================================================================
_microstructure_engine_instance: Optional[MarketMicrostructureEngine] = None
