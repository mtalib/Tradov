...
class SpyderDiagnostic:
    ...
    def test_python_environment(self):
        ...
        if sys.version_info >= (3, 8):
            ...
            self.add_result("Python Version", "FAIL", f"{sys.version_info.major}.{sys.version_info.minor}", 
    ...
    def test_minimal_system_startup(self):
        ...
        try:
            ...
            try:
                ...
                risk_manager = RiskManager(event_manager=em, config={'portfolio_value': 100000})
