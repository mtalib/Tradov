...
Series: SpyderG_GUI
Module: SpyderG32_AgentHealthDashboard.py
...
Module Description:
    ...
    (daemon) agents.  Data is sourced from SpyderU12_AgentIntegration's
...
Dependencies:
    ...
    • SpyderU12_AgentIntegration: AgentRegistry singleton
