...
Series: TradovE_Risk
Module: TradovE05_AutomaticRebalancer.py
...
class HedgeInstrument(Enum):
    ...
    TRAD_SHARES = "TRAD_SHARES"
    TRAD_OPTIONS = "TRAD_OPTIONS"
...
class TradovAutomaticRebalancer:
    """
    ...
    def _create_delta_hedge(
        ...
        if hedge_instrument != HedgeInstrument.TRAD_SHARES:
    ...
    def _create_gamma_hedge(
        ...
        hedge_instrument = HedgeInstrument.TRAD_OPTIONS
    ...
    def _create_vega_hedge(
        ...
        # Vega hedging typically uses VIX options or TRAD options
    ...
    def _select_hedge_instrument(self, greek: str, size: float, urgency: str) -> HedgeInstrument:
        ...
        if greek == "delta":
            return HedgeInstrument.TRAD_SHARES
        elif greek == "vega":
            return HedgeInstrument.VIX_OPTIONS
        else:
            return HedgeInstrument.TRAD_OPTIONS
    ...
    async def _execute_delta_hedge(self, action: RebalanceAction):
        ...
        if action.hedge_instrument == HedgeInstrument.TRAD_SHARES:
            order = {
                "symbol": "TRAD",
...
async def main():
    ...
    rebalancer = TradovAutomaticRebalancer()
...
AutomaticRebalancer = TradovAutomaticRebalancer
